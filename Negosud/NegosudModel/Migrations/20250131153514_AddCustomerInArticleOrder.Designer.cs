...
namespace NegosudModel.Migrations
{
    ...
    [Migration("20250131153514_AddCustomerInArticleOrder")]
    partial class AddCustomerInArticleOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NegosudModel.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NegosudModel.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NegosudModel.Entities.ArticleOrder", b =>
                {
                    ...
                    b.HasOne("NegosudModel.Entities.Person", "Person")
                        .WithMany()
